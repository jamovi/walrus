...
rttestPSOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "rttestPSOptions",
...
rttestPSResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "rttestPSResults",
...
rttestPSBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "rttestPSBase",
